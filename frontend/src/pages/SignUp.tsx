            ...
            >
                ...
                <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-xl font-display font-medium tracking-tight mb-2">Begin Journey</h1>
                        <p className="text-muted-foreground text-xs">Create your neural profile.</p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-[10px] text-muted-foreground uppercase tracking-widest">
                            ...
                            <Link to="/signin" className="text-white hover:underline decoration-white/20 underline-offset-4">
                                Sign In
                            </Link>
                        </p>
                    </div>
